        ...
        <div className={styles.container}>
          ...
          <div class="d-none d-sm-block mb-5 pb-4">
           ...
           {/*  <div id="map" className={styles.map}>
              ...
              <div className={styles.mapContainer}>
                ...
                <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                  ...
                  <div style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto, Arial, sans-serif; color: rgb(34, 34, 34); box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 16px; z-index: 10000002; display: none; width: 300px; height: 180px; position: absolute; left: 315px; top: 150px;">
                    ...
                    <div style="font-size: 13px;">Map data ©2019 Google
                    </div>
                  ...
                  <div class="gmnoscreen" style="position: absolute; right: 0px; bottom: 0px;">
                    <div style="font-family: Roboto, Arial, sans-serif; font-size: 11px; color: rgb(68, 68, 68); direction: ltr; text-align: right; background-color: rgb(245, 245, 245);">Map data ©2019 Google
                    </div>
                  </div>
              ...
              <div style="background-color: white; font-weight: 500; font-family: Roboto, sans-serif; padding: 15px 25px; box-sizing: border-box; top: 5px; border: 1px solid rgba(0, 0, 0, 0.12); border-radius: 5px; left: 50%; max-width: 375px; position: absolute; transform: translateX(-50%); width: calc(100% - 10px); z-index: 1;"><div>
                ...
                <div style="line-height: 20px; margin: 15px 0px;"><span style="color: rgba(0, 0, 0, 0.87); font-size: 14px;">This page can't load Google Maps correctly.</span>
                </div><table style="width: 100%;"><tr><td style="line-height: 16px; vertical-align: middle;"><a href="https://developers.google.com/maps/documentation/javascript/error-messages?utm_source=maps_js&amp;utm_medium=degraded&amp;utm_campaign=billing#api-key-and-billing-errors" target="_blank" rel="noopener" style="color: rgba(0, 0, 0, 0.54); font-size: 12px;">Do you own this website?</a></td><td style="text-align: right;">
                  <button class="dismissButton">OK
                  </button></td></tr></table>
...
<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores sit veritatis nam consectetur, saepe dolorem accusantium est repellat, maxime ratione temporibus qui reiciendis blanditiis mollitia? Cum magni corrupti placeat, labore veniam nam aliquam tempore! Aliquam tenetur corporis maxime id fuga autem hic rerum ex aut at! Repellendus obcaecati dolores tenetur ratione numquam et aspernatur rem, quae quisquam animi quam laborum, optio adipisci iusto ex accusantium at? Sequi laboriosam corporis repudiandae temporibus tenetur sint voluptatibus, eligendi fugiat est quasi at quisquam minus delectus sunt provident vitae nesciunt inventore quas reprehenderit omnis magnam. Accusantium, consequuntur nostrum veniam voluptatem quas porro itaque tempore maxime odit fugit ad et vero modi pariatur doloribus, quod adipisci voluptate. Possimus obcaecati ex, vel commodi, error nemo dolorem adipisci repellendus est ducimus corrupti harum? Eum similique nobis expedita enim, aliquam ducimus fugit natus a. Officia, eligendi eveniet! Tempora, doloremque consectetur officiis aliquid voluptatibus laudantium libero dicta laborum soluta maxime iure similique deleniti, illum obcaecati illo ullam at? Harum numquam inventore itaque veniam molestias! Delectus ipsa quam nulla. Suscipit perferendis, sint distinctio praesentium dignissimos natus? Veritatis commodi placeat ipsa consequuntur repellendus ad et voluptas, libero, esse nobis laudantium voluptatibus est ducimus excepturi. In itaque dolore incidunt deleniti cum? Veritatis.</p>

          </div>



          <div className={styles.contactWarpper}>
            ...
            <div class="col-lg-8">
              <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                ...
                <div class="form-group mt-3">
                  ...
                  <button type="submit" class="button button-contactForm boxed-btn">Send
                  </button>
